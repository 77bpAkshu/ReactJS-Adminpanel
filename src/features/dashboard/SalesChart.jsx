...
`;
  ...
  function SalesChart({bookings, numDays}) {
    ...
    //     totalSales: bookings
    //     .filter(
    //       booking => isSameDay(date, new Date(booking.created_at))
    //     ).reduce((acc, cur) => acc + cur.totalPrice, 0), 
    //     extrasSales: bookings.filter(
    //       booking => isSameDay(date, new Date(booking.created_at))
    ...
    return (
      <StyledSalesChart>
        <Heading as="h2">
          ...
          &mdash; {format(allDates[allDates.length - 1], 'MMM dd yyyy')}
        </Heading>
